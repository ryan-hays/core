...
import numpy as np
import re
from snok_input import image_and_label_queue,index_the_database_into_queue
from snok import FLAGS
from snok_networks import wide_conv_net
from collections import defaultdict


FLAGS.saved_session = './summaries/1_netstate/saved_state-1343'
FLAGS.predictions_file_path = re.sub("netstate","logs",FLAGS.saved_session)
FLAGS.database_path = '../../common/data/holdout_av4'
FLAGS.num_epochs = 10
