...
from snok_atomdict import atom_dictionary
    ...
    for dirpath, dirnames, filenames in os.walk(database_path + "/" + positives_folder):
        for filename in filenames:
            if re.search('.pdb$', filename):
                ...
                ligand_output_file = path_to_pdb_subfolder + "/" + path_to_positive.split("/")[-1].split(".")[
                    0] + '.av4'
...
convert_database_to_av4(database_path="../datasets/holdout_pdb", positives_folder="crystal_ligands",
