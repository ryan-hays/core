...
def nilai_net(x_image_batch,keep_prob,batch_size):
    ...
    with tf.name_scope("input_reshape"):
        ...
        x_image_with_depth = tf.reshape(x_image_batch, [batch_size, 40, 40, 40, 100])
        print "input to the first layer dimensions", x_image_with_depth.get_shape()

    h_conv1 = conv_layer(layer_name='conv1_5x5x5', input_tensor=x_image_with_depth, filter_size=[5, 5, 5, 100, 20])
...
def intuit_net(x_image_batch,keep_prob,batch_size):
    ...
    h_conv1 = conv_layer(layer_name='conv1_5x5x5', input_tensor=x_image_with_depth, filter_size=[5, 5, 5, 100, 20], padding='VALID')
    h_relu1 = relu_layer(layer_name='relu1', input_tensor=h_conv1)
...
def conv_net(x_image_batch,keep_prob,batch_size):
    ...
    h_conv1 = conv_layer(layer_name='conv1_7x7x7', input_tensor=x_image_with_depth, filter_size=[7, 7, 7, 100, 20], padding='VALID')
    h_relu1 = relu_layer(layer_name='relu1', input_tensor=h_conv1)
...
def fast_net(x_image_batch,keep_prob,batch_size):
    ...
    with tf.name_scope("input_reshape"):
        print "image batch dimensions", x_image_batch.get_shape()
        # formally adding one depth dimension to the input
        x_image_with_depth = tf.reshape(x_image_batch, [batch_size, 20, 20, 20, 100])
        print "input to the first layer dimensions", x_image_with_depth.get_shape()
...
def thin_net(x_image_batch,keep_prob,batch_size):
    ...
    h_conv1 = conv_layer(layer_name='conv1_5x5x5', input_tensor=x_image_with_depth, filter_size=[5, 5, 5, 100, 10], padding='VALID')
    h_relu1 = relu_layer(layer_name='relu1', input_tensor=h_conv1)
    h_pool1 = pool_layer(layer_name='pool1_2x2x2', input_tensor=h_relu1, ksize=[1, 2, 2, 2, 1], strides=[1, 2, 2, 2, 1], padding='VALID')
...
def thick_net(x_image_batch,keep_prob,batch_size):
    ...
    h_conv1 = conv_layer(layer_name='conv1_5x5x5', input_tensor=x_image_with_depth, filter_size=[5, 5, 5, 100, 40], padding='VALID')
    h_relu1 = relu_layer(layer_name='relu1', input_tensor=h_conv1)
    h_pool1 = pool_layer(layer_name='pool1_2x2x2', input_tensor=h_relu1, ksize=[1, 2, 2, 2, 1], strides=[1, 2, 2, 2, 1], padding='VALID')
...
def O30_net(x_image_batch,keep_prob,batch_size):
    ...
    with tf.name_scope("input_reshape"):
        print "image batch dimensions", x_image_batch.get_shape()
        # formally adding one depth dimension to the input
        x_image_with_depth = tf.reshape(x_image_batch, [batch_size, 60, 60, 60, 100])
        print "input to the first layer dimensions", x_image_with_depth.get_shape()
...
def O25_net(x_image_batch,keep_prob,batch_size):
    ...
    with tf.name_scope("input_reshape"):
        print "image batch dimensions", x_image_batch.get_shape()
        # formally adding one depth dimension to the input
        x_image_with_depth = tf.reshape(x_image_batch, [batch_size, 80, 80, 80, 100])
        print "input to the first layer dimensions", x_image_with_depth.get_shape()
