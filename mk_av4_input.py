...
def index_the_database(database_path):
    ...
    open("./filenames_found.csv", "w").writelines(ligand_file_list)
...
def read_receptor_and_ligand(filename_queue,num_epochs,examples_in_database):
    ...
    return idx,tf.squeeze(label),ligand_elements,tf.squeeze(ligand_coords),receptor_elements,tf.squeeze(multiframe_receptor_coords)
...
def convert_protein_and_ligand_to_image(ligand_elements,ligand_coords,receptor_elements,receptor_coords,side_pixels,pixel_size):
    ...
    return dense_complex,final_transition_matrix
...
def image_and_label_queue(sess,batch_size,pixel_size,side_pixels,num_threads,database_path,num_epochs):
    ...
    dense_image,final_transition_matrix = convert_protein_and_ligand_to_image(ligand_elements,ligand_coords,receptor_elements,receptor_coords,side_pixels,pixel_size)
    ...
    return current_epoch,dense_image,final_transition_matrix